...
spec.nodes(2).mechanism_list = {'dendGolombK','dendGolombKdr','dendGolombNa','dendInput','dendLeak','iPeriodicPulsesBen'};
...
[~,~]=dsSimulate(spec,...
              ...
              'save_data_flag',save_data_flag,'study_dir','PP_low_duty_cycle',...
