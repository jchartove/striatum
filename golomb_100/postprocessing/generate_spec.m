function generate_spec(directory, avgfr, min_ISI, max_ISI, timefactor, spike_pairs, v_new, filenew, time, dt, numcells, fileID, formatSpec, mods)
		...
		output = {strcat(filenew,',') strcat(num2str(avgfr),',') strcat(num2str(spike_pairs),',') ... 
            ...
            strcat(num2str(min_ISI),',') strcat(num2str(max_ISI),',') strcat(num2str(min_ISI/timefactor),',') strcat(num2str(max_ISI/timefactor),',')  ...
