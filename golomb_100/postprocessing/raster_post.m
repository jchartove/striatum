...
for file = datafiles'
	...
	h1 = plot(time(time > low_time)', D2_spikes*diag(1:size(D1_V, 2))', '.', 'Color', [1 .85 0], 'MarkerSize', 10);
	hold on
	h2 = plot(time(time > low_time)', D1_spikes*diag(1:size(D2_V, 2))', '.', 'Color', [.8 .5 .7], 'MarkerSize', 10);
	...
	%val2 = num2str(cell2mat(mods(11,3)'))
