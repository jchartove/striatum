...
vary={
  '(soma-soma,dend-dend, soma, dend,D1,D2)', 'DA',	[0,1];
  '(D1,D2, dend)',			'kernel_type',	[100];
  '(D1,D2, dend)',			'PPstim',	[0:-0.2:-1];
...
dsSimulate(spec,...
              ...
              'save_data_flag',save_data_flag,'study_dir','network_noiseless2',...
              ...
              'vary',vary, 'dt', .01, 'batch_dir', '/projectnb/crc-nak/chartove/batchdirs');%, ...
			  %'qsub_mode', qsub_mode,
